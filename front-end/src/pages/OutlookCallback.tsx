...
import { exchangeCodeForTokens } from "@/lib/outlook-api";
  ...
  useEffect(() => {
    ...
    exchangeCodeForTokens(code, redirectUri)
      .then((tokens) => {
        ...
        sessionStorage.setItem("outlook_access_token", tokens.access_token);
        sessionStorage.setItem("outlook_refresh_token", tokens.refresh_token);
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Connecting to Outlook...</p>
      </div>
    </div>
  );
};
