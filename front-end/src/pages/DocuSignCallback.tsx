...
import { exchangeCodeForTokens } from "@/lib/docusign-api";
...
const DocuSignCallback = () => {
    ...
    useEffect(() => {
        ...
        exchangeCodeForTokens(code, redirectUri)
            .then((tokens) => {
                sessionStorage.setItem("docusign_access_token", tokens.access_token);
                sessionStorage.setItem("docusign_refresh_token", tokens.refresh_token);
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-background">
            <div className="text-center">
                ...
                <p className="text-muted-foreground">Connecting to DocuSign...</p>
            </div>
        </div>
    );
};
